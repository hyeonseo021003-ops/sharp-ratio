...
test_sets = TEST_SIZE // PER_SET  # 200,000명
...
def train_step(data_x_3d, data_y_3d, num_epochs=150):
    for epoch in range(num_epochs):
        ...
        probs_3d_full = probs_flat.view(80, 10000, 2) # 다시 (80팀, 10000명)으로 복구
        probs_3d = probs_3d_full[:, :, 1]
...
def get_model_predictions(test_x_3d, test_y_3d, threshold=0.6):
    ...
    # dim=-1은 마지막 차원(2개 점수) 중 큰 인덱스를 고르라는 뜻입니다.
    decisions = torch.argmax(probs_3d_full, dim=-1).float() # 결과: (10, 3000)
